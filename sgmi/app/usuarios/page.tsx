...
import ModalEliminar from "@/app/components/modalEliminar";
  ...
  return (
    <div className="min-h-screen flex bg-[#f3f4f6] font-sans">
          ...
          {isLoading ? (
            ...
            usuarios
              ...
              .map((u, i) => (
                ...
                >
                  <div className="px-4 py-4 border-r border-gray-300">{u.nombre}</div>
                  <div className="px-4 py-4 border-r border-gray-300">{u.email}</div>
                  <div className="px-4 py-4 border-r border-gray-300">{u.role}</div>
      ...
      <ModalEliminar
        ...
        texto={`¿Seguro que deseas eliminar a ${usuarioSeleccionado?.nombre || 'este usuario'}?`}
      />
    </div>
  );
}
